...
As you can expect, it doesn't have many features. For example, it only supports exporting spans to an OTEL-HTTP-compatible collector, doesn't support sampling, etc. 
